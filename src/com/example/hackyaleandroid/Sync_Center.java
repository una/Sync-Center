...
public class Sync_Center extends Activity {
	...
	private void setRecurringAlarm() {
        ...
        Intent alarmIntent = new Intent(this, null);
        ...
        alarms.setInexactRepeating(AlarmManager.RTC_WAKEUP, currentTime.toMillis(true), 1000 * 5, recurringDownload); //will run it after every 5 seconds.
    }
